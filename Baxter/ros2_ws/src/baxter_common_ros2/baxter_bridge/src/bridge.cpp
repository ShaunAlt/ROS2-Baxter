...
namespace baxter_bridge
{
  ...
  bool Bridge::initRSP()
  {
    ...
    /*
    In the original code, model.initString(description) was not commented.
    However, in this implementation it is commented out since the program crashes when initString()
    is called due to segmentation error. Therefore, the lines associated with the function
    are commented out. 
    */
